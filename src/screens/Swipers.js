    ...
    return (
      <Swiper style={styles.wrapper} loop={false} showsButtons={true}>
         <View style={styles.slide1}>
           <Image source={require('../static/images/swipe1.png')} resizeMode={'cover'} style={styles.covers}></Image>
         </View>
         <View style={styles.slide2}>
           <Image source={require('../static/images/swipe2.png')} resizeMode={'cover'} style={styles.covers}></Image>
         </View>
